...
<template>
    <div
        class="w-9 h-9 absolute bottom-28 shadow-md bg-white z-50 flex items-center justify-center right-10 rounded-full overflow-hidden button-action transition-all ease-linear duration-300"
        @click="gotoTop"
        :class="{
